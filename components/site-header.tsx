...
import { Menu, Home, User, Briefcase, Award, Mail } from "lucide-react"
      ...
      <div className="container mx-auto max-w-4xl">
        <div className="flex h-14 items-center justify-between px-6 liquid-glass-header rounded-full">
          ...
          <Link href="/" className="flex items-center gap-1.5">
            <span className="font-semibold tracking-wide text-white">Rohit Amal Raj</span>
          </Link>
            ...
            <Sheet>
              ...
              >
                ...
                <div className="flex items-center gap-1.5 px-4 py-4 border-b border-gray-800">
                  <span className="font-semibold tracking-wide text-white text-lg">Rohit Amal Raj</span>
                </div>
