      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="flex flex-wrap justify-center gap-6 mb-8">
          <a
            ...
            className="flex items-center gap-2 px-4 py-2 bg-gray-800 hover:bg-gray-700 rounded-lg transition-colors duration-300 hover:text-lime-400"
          >
          ...
          <a
            href="https://linkedin.com/in/rohit-amal-raj"
            target="_blank"
            rel="noopener noreferrer"
          ...
          <a
            href="https://instagram.com/pov.roh1t"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 rounded-lg transition-colors duration-300"
          >
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="text-center pt-8 border-t border-gray-800">
          <p className="text-gray-400 text-sm">
            © 2025 Rohit Amal Raj. All rights reserved.
          </p>
