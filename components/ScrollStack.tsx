...
const ScrollStack: React.FC<ScrollStackProps> = ({
  ...
  const updateCardTransforms = useCallback(() => {
    ...
    // Find the end element for proper pin release
    const endElement = container.querySelector('.scroll-stack-end') as HTMLElement;
    const endElementTop = endElement ? endElement.offsetTop + containerTop : containerTop + container.offsetHeight;
  ...
  return (
    <div
      ...
      ref={containerRef}
    >
      <div className="relative min-h-screen pt-20 pb-64">
        {children}
